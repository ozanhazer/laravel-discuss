...
@section('content')
  <input type="search" name="q" placeholder="@lang('discuss::discuss.search_in_discussions_placeholder')" class="form-control">
  ...
  @foreach($threads as $thread)
    <div class="media mt-4">
      ...
      <div class="media-body">
        ...
        <a href="{{route('discuss.user', $thread->author)}}" class="tw-uppercase tw-font-bold">{{$thread->author->name}}</a>
